  ...
  return (
    <AuthLayout formAnimation={formAnimation}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 md:space-y-2">
            ...
            {/* Confirm Password Input (built-in toggle) */}
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors.confirmPassword?.message ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#4169e1]'} focus:outline-none focus:ring-2 transition-all duration-200 pr-12`}
